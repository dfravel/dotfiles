...
- The installation and runcom setup is
  [tested weekly on real Ubuntu and macOS machines](https://github.com/dfravel/dotfiles-webpro/actions)
...
```bash
bash -c "`curl -fsSL https://raw.githubusercontent.com/dfravel/dotfiles/main/remote-install.sh`"
```
...
```bash
git clone https://github.com/dfravel/dotfiles.git ~/.dotfiles
```
